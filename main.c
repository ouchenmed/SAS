...
int main() {
        ...
        //5 presidents au minimum
        while (nombrePres < 5) {
                printf("\nChoix invalide, Veuillez entrer au minimum 5 presidents :  ");
                scanf("%d", & nombrePres);
        }

        //Remplissage du tableau Presidents
        ...
        //Remplissage du tableau Electeurs
        ...
        for (i = 0; i < nombreElect; i++) {
                ...
                //Electeur doit choisir un nombre qui correspond a la liste des presidents
        ...
        if (nombrePres2 == 1) {
                ...
                if (nombrePres3 == 1) {
                        ...
                        for (i = 0; i < nombrePres4; i++) {
                                printf("\nPresident %s a remporte l'election presidentielle !!!", TabPres4[0]);
                        }
                }
